...
const Navbar = () => {
  ...
  const loginOptions = () => {
    if(loggedIn) {
      ...
      return (
        <div>
          <a className="text-gray-800 dark:text-white duration-300 cursor-pointer hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800" href="/login">
            login
          </a>
          <a className="text-gray-800 cursor-pointer dark:text-white duration-300 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800" href="/signup">
            Sign Up 
          </a>
        </div>
      )
    ...
    <nav className="bg-sky-500/75 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div className="flex items-center lg:order-2">
           <NavLink className="text-gray-800 dark:text-white duration-300 cursor-pointer hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800" to="/main/login"
          >
            Log in
            </NavLink>
          
          <NavLink
            className="text-gray-800 cursor-pointer dark:text-white duration-300 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800" to="/main/signup"
          >
            Sign Up 
          </NavLink>
        </div>
