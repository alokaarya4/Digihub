...
const Login = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="bg-[url('/Login-here.png')]  min-h-screen bg-gray-100 py-6  flex flex-col justify-center sm:py-12">
            ...
            <div className="max-w-md mx-auto">
              ...
              <div className=" divide-gray-200">
                <div className="py-10 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="relative">
                    <button type="submit" className="bg-cyan-500 hover:bg-blue-800 active:bg-green-500 text-white rounded-md px-4 py-1 mt-4">
                      Login
                    </button>
                  </div>
                </div>
